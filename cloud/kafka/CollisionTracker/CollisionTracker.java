...
public class CollisionTracker {
    ...
    public static final int CHECKPOINTING_INTERVAL_MS = 10000;
    ...
    public static void main(final String[] args) throws  Exception {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///flink/checkpoints"); // save checkpoints to file
        ...
        .setProperty("sasl.jaas.config", saslconfig)
        .setProperty("sasl.mechanism", saslmechanism)
                .setProperty("client.dns.lookup", clientdnslookup)
        .setProperty("partition.discovery.interval.ms", "20000") // Dynamic Partition Discovery for scaling out topics
